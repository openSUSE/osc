...
class TestCommit(OscTestCase):
    ...
    def test_simple(self):
        ...
        self.assertEqual(open('nochange', 'r').read(), open(os.path.join('.osc', 'sources', 'nochange'), 'r').read())
    ...
    def test_addfile(self):
        ...
        self.assertEqual(open('add', 'r').read(), open(os.path.join('.osc', 'sources', 'add'), 'r').read())
