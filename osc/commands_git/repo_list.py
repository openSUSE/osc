...
class RepoListCommand(osc.commandline_git.GitObsCommand):
    ...
    def init_arguments(self):
        self.parser.add_argument("--org", dest="org_list", action="append", help="List repos owned by the specified organizations")
        self.parser.add_argument("--user", dest="user_list", action="append", help="List repos owned by the specified users")
