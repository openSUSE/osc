...
def branch_pkg(
    ...
    newinstance=False,
    disable_build=False,
) -> Tuple[Literal[False], Optional[str], Optional[str], Optional[str], Optional[str]]: ...
...
def branch_pkg(
    ...
    newinstance=False,
    disable_build=False,
) -> Union[Tuple[Literal[True], str, str, None, None], Tuple[Literal[False], Optional[str], Optional[str], Optional[str], Optional[str]]]: ...
